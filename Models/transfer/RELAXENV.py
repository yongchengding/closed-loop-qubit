...
from mixedstate import calfidelity, coupling, createpointer, dephasing, operatorP, operatorQ, perturb, primerotrace, relaxtion, three, seguiendotrace, sqrtm

# in evaluate_pretrained_escape = 1
# in evaluate_best_model_escape = 4
...
class WEAKMEASUREMENT(Environment):
    ...
    def execute(self, actions):
        ...
        self.rho = three(self.sx,self.gamma,TLS,self.rho,self.dt)        
