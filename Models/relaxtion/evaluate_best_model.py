...
agent.restore(directory='best-model',filename='518770')
...
baselinez = np.load("szrelaxtion.npy")
baseliney = np.load("syrelaxtion.npy")  
...
fig.savefig('rhodrl_relaxation.pdf',dpi=800,bbox_inches='tight',format='pdf')
...
ax.tick_params(axis='both', labelsize=20)
fig.savefig('omegadrl_relaxation.pdf',dpi=800,bbox_inches='tight',format='pdf')
