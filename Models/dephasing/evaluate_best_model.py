...
agent.restore(directory='best-model',filename='agent-151541')
...
baselinez = np.load("szmean_dephasing.npy")
baseliney = np.load("symean_dephasing.npy")  


fig,ax=plt.subplots(1, 1, sharey=False, sharex=False)
#plt.plot(tlist,Sxlist,color='g',alpha=0.2,linewidth=0.5)
...
fig.savefig('rhodrl_dephasing.pdf',dpi=800,bbox_inches='tight',format='pdf')
...
ax.tick_params(axis='both', labelsize=20)
fig.savefig('omegadrl_dephasing.pdf',dpi=800,bbox_inches='tight',format='pdf')
