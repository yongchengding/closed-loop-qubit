...
plt.title(r'$\Delta t/T=0.1,~N=20$',fontsize=20)
fig.savefig('pipulsesigma01.pdf',dpi=800,bbox_inches='tight',format='pdf')
...
plt.plot(tlist[1:len(tlist)],Qmean[1:len(Qmean)],color='k',label='$\overline{q_0}$')
...
ax.tick_params(axis='both', labelsize=20)
plt.title(r'$\Delta t/T=0.1,~N=20$',fontsize=20)
fig.savefig('pipulseq01.pdf',dpi=800,bbox_inches='tight',format='pdf')
